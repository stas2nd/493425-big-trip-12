...
const createEditingEventTemplate = () => {
  return (
...
const createEditingEventOffersTemplate = () => {
  return (
...
render(siteHeaderControlsElement, createMenuTemplate(), `beforeend`);
...
render(siteContentElement, createSortingTemplate(), `beforeend`);

render(siteContentElement, createEditingEventTemplate(), `beforeend`);
...
render(siteEditingFormDetailsElement, createEditingEventOffersTemplate(), `beforeend`);
